...
(function(){
    angular.module("PaperGrader")
        .controller('MyProfileEditorController', ['$rootScope','$scope','$http','$stateParams','$state', function($rootScope, $scope,$http,$stateParams,$state){
            ...
            $rootScope.userIn = $state.current.userIn;
                ...
                $scope.submitChanges = function(old_user, user_id){
                    ...
                    var query= '/api/edit/profile/' + user_id;
                    console.log(query);
